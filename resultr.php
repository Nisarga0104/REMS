...
<html>
       ...
       <body style="background-color:#e6fff9">
              ...
              <h1 class="text-center buyp pt-4" >PROPERTIES FOR RENT</h1>
              <?php
              ...
              $selectquery = "SELECT * FROM rent WHERE address = '$address' or BHK='$BHK' or f_type='$f_type' ";
              }
              else{
              $selectquery = "SELECT * FROM rent";
              }
              ...
              <div class="mb-2">
                     <div class="container buyp border rounded-lg" style="background-color: white">
                            <div class="row" >
                                   ...
                                   <div class="col-9 pt-4">
                                          <div class="row col-12">
                                                 ...
                                                 <div class="col-6">
                                                        <h3>Rent : <b>₹<?php echo $result['price']; ?></b></h3>
                                                 </div>
                                          </div>
                                          <div class="row col-12">
                                                 <div class="col-6">
                                          ...
                                          <div class="row col-12">
                                                 <div class="col-12"><p>Deposit : <b>₹<?php echo $result['deposit']; ?></b></p></div>
                                          </div>
                                          <div class="row col-12">
                                                 <div class="col-6">
